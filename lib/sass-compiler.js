...
class SassCompiler {
    ...
    setPrefixerOptions(options) {
        ...
        this.prefixerOptions = {
            ...
            overrideBrowserslist: options.overrideBrowserslist
        };

        // Compatible with older versions
        if(this.prefixerOptions.browsers) {
            this.prefixerOptions.overrideBrowserslist = this.prefixerOptions.browsers;
        }
        delete this.prefixerOptions.browsers;
